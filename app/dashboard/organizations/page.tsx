  ...
  return (
    <>
      <section className="w-full p-6 max-xl:p-2 mt-4 mx-auto bg-slate-50 dark:bg-secend_dash py-8 md:py-12 lg:py-20">
        ...
        <div className="flex h-screen max-xl:h-fit max-xl:flex-col  gap-6">
          <aside className="w-full overflow-y-auto h-full max-xl:h-[50vh] xl:w-1/4 bg-white dark:bg-secend_dash p-4 rounded-md shadow-lg">
