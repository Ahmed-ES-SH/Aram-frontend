        ...
        <div className="relative inline-block text-left w-fit">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 w-[150px] max-md:w-[40px] overflow-hidden max-md:p-0 max-md:rounded-full max-md:border-2 max-md:border-main_orange  rounded-md  bg-main_orange dark:bg-gray-600 px-3 py-2 shadow-md hover:bg-gray-300 dark:hover:bg-gray-700 duration-200"
            >
              <Img
