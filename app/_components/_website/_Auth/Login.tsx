        ...
        >
          ...
          >
            ...
            >
              ...
              <Link
                className="flex items-center justify-center rounded-md  w-full max-w-xs  text-sm font-medium text-gray-700 bg-white border-none  h-[50px] shadow hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200"
                href={`${main_api}/auth/facebook/redirect`}
              >
                <div className="w-[15%] flex items-center justify-center">
                  <Img src="/facebook.png" className="w-5 " />
                </div>
                <span className="w-[90%] flex items-center justify-center h-full bg-sky-400 rounded-r-md text-white">
