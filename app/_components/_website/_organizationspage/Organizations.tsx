    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-start max-xl:flex-col-reverse gap-2 p-2">
          ...
          />
          <RandomArticlesSidebar length={8} />
          {/* Main Content */}
          <div className="flex-1 min-h-screen max-xl:w-full border rounded-md dark:border-gray-700 dark:bg-secend_dash dark:text-secend_text px-3 py-6">
            <button
            ...
            {/* Organizations List */}
            <motion.div className="min-h-screen" layout>
              <AnimatePresence>
