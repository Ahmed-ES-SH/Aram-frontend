...
import Img from "../Img";
import { navbarlinks } from "@/app/constants/website";
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // تنظيف النمط عند إلغاء الكومبوننت
    return () => {
                  ...
                  <ul className="flex flex-col gap-4 text-sm mt-5">
                    ...
                    {!token && (
                      <div className="w-full flex flex-col gap-4">
                        ...
                        <li className="w-full">
                          <Link
                            className="rounded-md w-full block bg-gray-200 text-gray-400 hover:bg-main_orange hover:text-white duration-200 px-5 py-2.5 text-sm font-medium "
                            href="/membership"
                          >
                            {language == "EN" ? "Register" : "إنضم الأن"}
                          </Link>
