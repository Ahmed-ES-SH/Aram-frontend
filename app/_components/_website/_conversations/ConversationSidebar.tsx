  ...
  return (
    <>
      <div className="  h-full min-h-screen  w-fit max-lg:fixed top-24 left-0 max-lg:z-[999] flex items-center">
        <div
          className={` h-full min-h-screen duration-300 overflow-hidden overflow-y-auto bg-gray-200 dark:bg-main_dash  border-r border-gray-200 dark:border-gray-700 ${
              ...
              conversations.map((conversation) => {
                ...
                return (
                  <Link
                    ...
                    key={conversation.id}
                    className=" flex relative items-center space-x-3 cursor-pointer hover:scale-105 duration-150 border-b bg-white dark:bg-secend_dash rounded-md shadow-md p-3 border-main_orange pb-3"
                  >
