...
export default function NotFound() {
  return (
    <motion.div
      className="flex fixed z-[99999999999] top-0 left-0 w-full flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-500 to-indigo-600 text-white"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
